...
def tail_points(opponent_score):
    ...
    ones_num = 0
    tens_num = 0
    ones_num = opponent_score%10
    tens_num = opponent_score//10%10
    return 2 * abs(tens_num-ones_num) +1 
...
def play(strategy0, strategy1, update,
    ...
    strategy0: The strategy for player0. number of dice for player0
    strategy1: The strategy for player1. number of dice for player1
    update:    The update function (used for both players). return the updated score of the current player
...
def is_always_roll(strategy, goal=GOAL):
    ...
    # BEGIN PROBLEM 7
    "*** YOUR CODE HERE ***"
    for item0 in range(0,101):
        for item1 in range(0,101):
            if strategy(item0, item1) != strategy(0,0):
                return False
    return True
...
def make_averaged(original_function, total_samples=1000):
    ...
    # BEGIN PROBLEM 8
    "*** YOUR CODE HERE ***"
    def averaged_dice(*args, dice=six_sided):
        rst = 0
        i = 0
...
def max_scoring_num_rolls(dice=six_sided, total_samples=1000):
    ...
    while i <= 10:
        test_score = averaged_dice(i, dice)
        i  = i+1
...
def tail_strategy(score, opponent_score, threshold=12, num_rolls=6):
    ...
    """
    # BEGIN PROBLEM 10
    num_roll_is_0 = tail_points(opponent_score)
    if num_roll_is_0 >= threshold:
        return 0
    else:
        return num_rolls
